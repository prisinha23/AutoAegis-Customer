...
public class TyreAdapter extends RecyclerView.Adapter<TyreAdapter.ViewHolder> {
    ...
    public TyreAdapter(List<TyreModel> tyreModelList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        String resource=tyreModelList.get(position).getProduct_image();
        String title=tyreModelList.get(position).getProduct_title();
        String price=tyreModelList.get(position).getProduct_price();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private void setData(final String resource, final String title, final String price){
            ...
            add_to_cart.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {final String product_id=firebaseFirestore.collection("USERS").document(firebaseAuth.getCurrentUser().getUid()).collection("USER_CART").getId();
                    Map<Object,String> product_added_id=new HashMap<>();
                    product_added_id.put("product_id","tyre_order_no"+value);
                    ...
                    firebaseFirestore.collection("USERS").document(firebaseAuth.getCurrentUser().getUid()).collection("USER_CART").document("tyre_order_no"+value).set(product_added_id).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
